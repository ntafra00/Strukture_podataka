...
int addOnBeggining(position *);                 // funkcija koja dodaje element na početak liste
...
position findPreviousElement(position, char[]); // funckija koja pronalazi prethodni element po prezimenu
